...
public:
	...
	inline quaternion(const double src_x, const double src_y, const double src_z, const double src_w) : x(src_x), y(src_y), z(src_z), w(src_w) { /* custom constructor */ }

	inline double self_dot(void)
	{
